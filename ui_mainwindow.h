...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(370, 30, 331, 321));
        ...
        blueButton = new QPushButton(gridLayoutWidget);
        ...
        gridLayout->addWidget(blueButton, 2, 3, 1, 1);

        tabWidget = new QTabWidget(centralWidget);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(10, 210, 331, 121));
        tab_2 = new QWidget();
        ...
        widget->setGeometry(QRect(10, 30, 340, 70));
...
"color: rgb(252, 108, 109);"));
        ...
        widget_2->setGeometry(QRect(10, 110, 340, 50));
        ...
        widget_3->setGeometry(QRect(10, 170, 340, 50));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        blueButton->setText(QApplication::translate("MainWindow", "\347\241\256\345\256\232", nullptr));
